...
<body>
  <header>
    ...
    <div class="nav">
        ...
        <div class="dropdown">
            ...
            <a href="http://localhost/bookflix/index.php#New">New Arrived</a>
                <a href="http://localhost/book-store-2/index.php#Adventure">Adventure</a>
                <a href="http://localhost/book-store-2/index.php#Magical">Magic</a>
                <a href="http://localhost/book-store-2/index.php#Knowledge">Knowledge</a>
            </div>
        </div>
    ...
    <a class="Btn" href="search_books.php"><img style="height:30px;" src="./images/sea2.png" alt=""></a>
     <img style="height:40px; margin-left:10px; border-radius:50%;" src="images/<?php echo $p_picture;?>" class="user-pic" onclick="toggleMenu()" />     </div>
     
</header>
<div class="sub-menu-wrap" id="subMenu">
  <div class="sub-menu">
    <div class="user-info">
      <img src="images/kitessa.jpg" />
