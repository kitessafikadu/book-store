...
<body>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a style="color:rgb(255, 187, 0);" href="users_detail.php?update_user=<?php echo $fetch_admin['Id']; ?>">Update</a>
            <a href="users_detail.php?delete_user=<?php echo $fetch_admin['Id']; ?>" onclick="return confirm('Are you sure you want to delete this user');">Delete</a>
        </div>
        <?php
        }
    }else{
